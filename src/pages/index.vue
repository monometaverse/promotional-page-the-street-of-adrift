...
<template>
  <div class="route-page">
    <div
      class="transition-all duration-500 delay-0 logo-copy logo-copy-center cover-no-repeat-center"
      :style="logoCopyStyle"
      :class="{
    ...
    >
      <a
        class="community-btn community-btn-discord clickble !transition-all !duration-500 !delay-1000"
        :class="{
      ...
      />
      <a
        class="community-btn community-btn-twitter clickble !transition-all !duration-500 !delay-1000"
        :class="{
          'social-btns-hide': !animationStart,
        }"
    ...
    <div
      class="transition-all duration-500 delay-500 logo-and-play"
      :class="{
    ...
    >
      <span
        class="text transition-all duration-500 delay-1500"
        :class="{
      ...
      <span
        ...
        class="text transition-all duration-500 delay-1750"
        :class="{
          'text-hide': !animationStart,
          '!inline': locale === 'en'
        }"
